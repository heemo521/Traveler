...
class oldSearchView: UIViewController, UISearchBarDelegate {
...
extension oldSearchView: MKLocalSearchCompleterDelegate, UITableViewDelegate {
...
extension oldSearchView: UITableViewDataSource {
